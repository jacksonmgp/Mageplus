...
class ColorConfig extends Field
{
    ...
    {
        $fieldSelectorAttr = \Mageplus\Base\Block\Adminhtml\System\Config\Form\Field\Color::FIELD_SELECTOR_ATTRIBUTE;
                ...
                require(["jquery", "spectrum", "module"], function(jQuery, colorpicker, module) {
                    jQuery(function($) {
                        ...
                        var processColor = function(elem, color) {
                            ...
                            // If input color is not tiny color, validate the input
                        ...
                        var initSpectrum = function($field) {
                            ...
                            $field.spectrum({
                                ...
                                , cancelText: "Cancel"
                                , chooseText: "Apply"
                                , localStorageKey: "mageplus.base.color"
